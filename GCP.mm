...
<node BACKGROUND_COLOR="#3399ff" CREATED="1578905159096" FOLDED="true" ID="ID_1365779485" MODIFIED="1580226394841" POSITION="right" TEXT="STORAGE">
<edge WIDTH="2"/>
...
<node BACKGROUND_COLOR="#ff6600" CREATED="1578906512336" ID="ID_1563293127" MODIFIED="1580123720872" TEXT="Objects storage system"/>
...
<node BACKGROUND_COLOR="#ff6600" CREATED="1578906499400" ID="ID_811381357" MODIFIED="1580123759654" TEXT="It&apos;s not a file system"/>
<node BACKGROUND_COLOR="#ff6600" CREATED="1578906499400" ID="ID_604246829" MODIFIED="1580124103464" TEXT="Multiregion storage allows for faster access to data when users or applications are distributed across regions"/>
</node>
<node BACKGROUND_COLOR="#3399ff" CREATED="1578906260839" FOLDED="true" ID="ID_645299442" MODIFIED="1580130414279" TEXT="Relational Database Support">
<node BACKGROUND_COLOR="#0099ff" CREATED="1578905244258" ID="ID_1829723618" MODIFIED="1580129951182" TEXT="Cloud Sql">
...
<node BACKGROUND_COLOR="#0099ff" CREATED="1578905244258" ID="ID_893540148" MODIFIED="1580130217869" TEXT="Cloud Spanner">
...
<node BACKGROUND_COLOR="#33ffcc" CREATED="1578905638156" ID="ID_1146904218" MODIFIED="1580130252184" TEXT="99,999 percent availability SLA"/>
<node BACKGROUND_COLOR="#33ffcc" CREATED="1578905638156" ID="ID_1196569354" MODIFIED="1580130395816" TEXT="Encryption at rest and encryption in transit."/>
</node>
</node>
<node BACKGROUND_COLOR="#3399ff" CREATED="1578906290847" FOLDED="true" ID="ID_1767301120" MODIFIED="1580130714231" TEXT="No SQL">
<node BACKGROUND_COLOR="#0099ff" CREATED="1578905244258" FOLDED="true" ID="ID_1683660187" MODIFIED="1580130216936" TEXT="Cloud Big Table">
...
<node BACKGROUND_COLOR="#ffcc00" CREATED="1578905713409" ID="ID_1474889738" MODIFIED="1580130181642" TEXT="It can manage up to billions of rows and thousands of columns"/>
</node>
<node BACKGROUND_COLOR="#0099ff" CREATED="1578905654664" ID="ID_1435970186" MODIFIED="1580130415762" TEXT="Datastore">
...
<node BACKGROUND_COLOR="#ff6666" CREATED="1578905765760" ID="ID_1104792687" MODIFIED="1580130532503" TEXT="It&apos;s accessed via a Rest API and can be used for applications in Compute Engine, Kubernetes Enginer or App Engine"/>
<node BACKGROUND_COLOR="#ff6666" CREATED="1578905765760" ID="ID_1055931476" MODIFIED="1580130575430" TEXT="It can scale based on load."/>
<node BACKGROUND_COLOR="#ff6666" CREATED="1578905765760" ID="ID_1516143835" MODIFIED="1580130639208" TEXT="It&apos;s a managed services so it takes care of replication, backups, and other database administration tasks"/>
</node>
</node>
<node BACKGROUND_COLOR="#0099ff" CREATED="1578905244258" FOLDED="true" ID="ID_1906972901" MODIFIED="1580124526566" TEXT="Cloud Big Query">
...
<node BACKGROUND_COLOR="#3399ff" CREATED="1578906450950" FOLDED="true" ID="ID_1306783353" MODIFIED="1580130974326" TEXT="Cloud Filestore">
<node BACKGROUND_COLOR="#ff6600" CREATED="1578906464136" ID="ID_1716312722" MODIFIED="1580124642264" TEXT="To have access to a file system housed on network-attached storage"/>
<node BACKGROUND_COLOR="#ff6600" CREATED="1578906499400" ID="ID_291699589" MODIFIED="1580124695447" TEXT="Provides a shared file system for use with Compute Engine and Kubernetes Engine"/>
<node BACKGROUND_COLOR="#ff6600" CREATED="1578906499400" ID="ID_94815633" MODIFIED="1580124760583" TEXT="It can provide high numbers of input-output operations per second (IOPS) "/>
<node BACKGROUND_COLOR="#ff6600" CREATED="1578906499400" ID="ID_1781520543" MODIFIED="1580124754918" TEXT="It implements the Network File System (NFS) "/>
</node>
<node BACKGROUND_COLOR="#3399ff" CREATED="1578906450950" ID="ID_976830721" MODIFIED="1580130741511" TEXT="Cloud memorystore">
<node BACKGROUND_COLOR="#ff6600" CREATED="1578906464136" ID="ID_84612584" MODIFIED="1580130767430" TEXT="It&apos;s an in-memory cache service"/>
...
<font BOLD="true" NAME="SansSerif" SIZE="12"/>
<node BACKGROUND_COLOR="#0099ff" CREATED="1578907525654" ID="ID_200228941" MODIFIED="1580131214903" TEXT="Interconnect Options/Interconnecting newtorks">
...
<font BOLD="true" NAME="SansSerif" SIZE="12"/>
<node BACKGROUND_COLOR="#ccccff" CREATED="1578913614681" ID="ID_418907880" MODIFIED="1580131216538" TEXT="Connect your infrastructure with Google&apos;s network">
<node BACKGROUND_COLOR="#ccccff" CREATED="1578913371082" ID="ID_1278912227" MODIFIED="1580132552043" TEXT="Cloud interconnect and peering">
...
<node BACKGROUND_COLOR="#ccccff" CREATED="1578907561008" ID="ID_1226728928" MODIFIED="1580132555260" TEXT="Dedicated Interconnect">
<font BOLD="true" NAME="SansSerif" SIZE="12"/>
...
<node BACKGROUND_COLOR="#ccccff" CREATED="1578907535593" FOLDED="true" ID="ID_551472683" MODIFIED="1580132553339" TEXT="VPN">
<font BOLD="true" NAME="SansSerif" SIZE="12"/>
...
<node BACKGROUND_COLOR="#9999ff" CREATED="1578922311297" FOLDED="true" ID="ID_855395980" MODIFIED="1580131213221" TEXT="VPC Peering">
<font BOLD="true" NAME="SansSerif" SIZE="12"/>
...
<node BACKGROUND_COLOR="#0099ff" CREATED="1578907433782" ID="ID_1988412452" MODIFIED="1580131196174" TEXT="Cloud DNS">
<font BOLD="true" NAME="SansSerif" SIZE="12"/>
...
<node BACKGROUND_COLOR="#3399ff" CREATED="1579874264045" FOLDED="true" ID="ID_615661561" MODIFIED="1580131834460" TEXT="BASTION HOST ISOLATION">
<font BOLD="true" NAME="SansSerif" SIZE="12"/>
...
<node BACKGROUND_COLOR="#3399ff" CREATED="1579874264045" FOLDED="true" ID="ID_1027749726" MODIFIED="1580131769443" TEXT="FIREWALL RULES STRUCTURE">
<font BOLD="true" NAME="SansSerif" SIZE="12"/>
...
<node BACKGROUND_COLOR="#ccffcc" CREATED="1578923702307" ID="ID_1552076293" MODIFIED="1580372734616" TEXT="Automatic Restart">
<node BACKGROUND_COLOR="#ff9966" CREATED="1580239908261" ID="ID_1846304786" MODIFIED="1580372772404" TEXT="Indicates if the server stops because of a hardware failure or maintenance event"/>
</node>
<node BACKGROUND_COLOR="#ccffcc" CREATED="1578923702307" ID="ID_1559560499" MODIFIED="1580372782772" TEXT="On host maintenance">
<node BACKGROUND_COLOR="#ff9966" CREATED="1580239918306" ID="ID_1588846523" MODIFIED="1580372825908" TEXT="Indicates whether the virtual server should be migrated to another physical server when maintenance occurs"/>
</node>
</node>
<node BACKGROUND_COLOR="#3399ff" CREATED="1580121177736" FOLDED="true" ID="ID_378994804" MODIFIED="1580374360521" TEXT="SECURITY - SHIELDED VMS">
<font BOLD="true" NAME="SansSerif" SIZE="12"/>
<node BACKGROUND_COLOR="#ccffcc" CREATED="1578923702307" ID="ID_417320340" MODIFIED="1580372893033" TEXT="Secure Boot">
<node BACKGROUND_COLOR="#ff9966" CREATED="1580239897018" ID="ID_1625786156" MODIFIED="1580372960850" TEXT="Ensure only authenticated operating system software runs on the VM"/>
</node>
<node BACKGROUND_COLOR="#ccffcc" CREATED="1578923702307" ID="ID_9472299" MODIFIED="1580372909861" TEXT="Virtual Trusted Platform Module">
<node BACKGROUND_COLOR="#ff9966" CREATED="1580239908261" ID="ID_689145195" MODIFIED="1580372982644" TEXT="Chip designed to protect keys and certificates"/>
</node>
<node BACKGROUND_COLOR="#ccffcc" CREATED="1578923702307" ID="ID_737596820" MODIFIED="1580372924756" TEXT="Integrity Monitoring">
<node BACKGROUND_COLOR="#ff9966" CREATED="1580239918306" ID="ID_1875895965" MODIFIED="1580373035003" TEXT="Compare recent boot measurements."/>
</node>
</node>
<node BACKGROUND_COLOR="#3399ff" CREATED="1580121177736" FOLDED="true" ID="ID_1859846068" MODIFIED="1580374383113" TEXT="SOLE TENANCY">
<font BOLD="true" NAME="SansSerif" SIZE="12"/>
...
<linktarget COLOR="#b0b0b0" DESTINATION="ID_805172333" ENDARROW="Default" ENDINCLINATION="0;0;" ID="Arrow_ID_912981646" SOURCE="ID_805172333" STARTARROW="None" STARTINCLINATION="0;0;"/>
</node>
<node BACKGROUND_COLOR="#ccffcc" CREATED="1578923702307" ID="ID_1279811870" MODIFIED="1580376283118" TEXT="The cost is based on machine type. The more CPUS and memory used, the higher the cost."/>
...
<node BACKGROUND_COLOR="#3399ff" CREATED="1579095659500" FOLDED="true" ID="ID_750961470" MODIFIED="1580224970534" POSITION="right" TEXT="STACK DRIVER">
<font BOLD="true" NAME="SansSerif" SIZE="12"/>
...
<node BACKGROUND_COLOR="#ff9966" CREATED="1579518532185" FOLDED="true" ID="ID_172324960" MODIFIED="1580224969286" TEXT="SERVICES">
<font BOLD="true" NAME="SansSerif" SIZE="12"/>
...
<node BACKGROUND_COLOR="#ffcccc" CREATED="1579875933765" ID="ID_1064839273" MODIFIED="1579877055034" TEXT="You can attach a disk in read mode for several VMS">
<font NAME="SansSerif" SIZE="12"/>
</node>
<node BACKGROUND_COLOR="#ffcccc" CREATED="1579875933765" ID="ID_913278637" MODIFIED="1580124393784" TEXT="They can be up to 64TB in size using either SSDs or HDDs.">
<font NAME="SansSerif" SIZE="12"/>
</node>
...
<font BOLD="true" NAME="SansSerif" SIZE="12"/>
<node BACKGROUND_COLOR="#ccffcc" CREATED="1580131706796" ID="ID_303427422" MODIFIED="1580131905395" TEXT="Allows to distribute workloads across your cloud infrastructure"/>
<node BACKGROUND_COLOR="#ccffcc" CREATED="1580131706796" ID="ID_1643995212" MODIFIED="1580131905395" TEXT="Using a single multicast Ip it can distribute the workload within and across regions"/>
...
<font BOLD="true" NAME="SansSerif" SIZE="12"/>
<node BACKGROUND_COLOR="#ffcc66" CREATED="1580131706796" ID="ID_1168737039" MODIFIED="1580132155829" TEXT="It&apos;s a google network security service that builds on the global https load balancing"/>
<node BACKGROUND_COLOR="#ffcc66" CREATED="1580131706796" ID="ID_1648265394" MODIFIED="1580132207287" TEXT="Ability to allow or restrict access based on Ip Address"/>
<node BACKGROUND_COLOR="#ffcc66" CREATED="1580131706796" ID="ID_1328000696" MODIFIED="1580132229749" TEXT="Ability to counter SQL injection attacks"/>
...
<node BACKGROUND_COLOR="#ffcc66" CREATED="1579688981914" ID="ID_1438834774" MODIFIED="1580375200336" TEXT="Stop instance -&gt; gcloud compute instances stop ${instanceName}"/>
<node BACKGROUND_COLOR="#ffccff" CREATED="1580374995168" ID="ID_1280643537" MODIFIED="1580375083341" TEXT="PARAMETERS">
<node BACKGROUND_COLOR="#66ff66" CREATED="1579688981914" ID="ID_1397454427" MODIFIED="1580375049807" TEXT="--boot-disk-size"/>
<node BACKGROUND_COLOR="#66ff66" CREATED="1580375004314" ID="ID_1585078175" MODIFIED="1580375049807" TEXT="--boot-disk-type "/>
<node BACKGROUND_COLOR="#66ff66" CREATED="1580375004314" ID="ID_95452427" MODIFIED="1580375049807" TEXT="--labels"/>
<node BACKGROUND_COLOR="#66ff66" CREATED="1580375004314" ID="ID_947402891" MODIFIED="1580375049807" TEXT="--machine-type"/>
<node BACKGROUND_COLOR="#66ff66" CREATED="1580375004314" ID="ID_1802328994" MODIFIED="1580375072497" TEXT="--preemptible"/>
</node>
</node>
</node>
</node>
